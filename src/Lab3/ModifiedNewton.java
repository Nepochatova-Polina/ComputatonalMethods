...
public class ModifiedNewton {
    ...
    public static double curX(double []x) {return Math.sin(x[0]-0.6)-x[1]-1.6;}
    public static double curY(double []x) {return 3*x[0] - Math.cos(x[1]) -0.9;}
    public static double derX1(double x) {return Math.cos(x-0.6);}
    public static double derY1() { return -1.0;}
    public static double derX2() {return 3.0;}
    public static double derY2(double y) {return Math.sin(y);}
